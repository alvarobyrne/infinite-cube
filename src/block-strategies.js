...
import { createBlock, createBlock1, createHollowBlock, createMultiColorPlaneBlock, createMultiColorBoxBlock, createLinesBlock, createTrapezoidBlock, createLine, create45AngleCornerBar, createWedgeAtBarEnds, createWedgeMeshAtBarEnds, createWedgeMeshAtBarEnds0 } from "./scene-setup.js";
...
export class WHDWedgeMeshesAtBarEndsStrategy extends WHDNodesBaseStrategy {
    execute(params) {
        ...
        const block = createWedgeMeshAtBarEnds0(whdState, nodesArray);
        // group.add(block);

        return { group:block };
    }
}
export class WHDBarStrategy extends WHDNodesBaseStrategy {
    execute(params) {
        const { scene, whdState, blockRenderState } = params;
        ...
        const block = createWedgeMeshAtBarEnds(whdState, nodesArray,blockRenderState.isOpaque?1:0.4, !blockRenderState.isOpaque);
        // group.add(block);
